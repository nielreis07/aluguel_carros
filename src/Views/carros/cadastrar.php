                ...
                <form action="/carros/salvar" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="ano" type="number" value="<?php echo $dados['ano'] ?? '' ?>" 
                            class="form-control" id="InputAno" aria-describedby="anoHelp">
                        <div id="anoHelp" class="form-text">Digite o ano do carro.</div>
                    </div>

                    <div class="mb-3">
                        <label for="InputPlaca" class="form-label">Placa</label>
                        <input name="placa" type="text" class="form-control" id="InputPlaca" aria-describedby="placaHelp">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="status" class="form-select" id="SelectStatus" 
                            aria-label="Selecione o status do carro" aria-describedby="statusHelp">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="preco" type="number" class="form-control" id="InputPreco" aria-describedby="precoHelp">
                        <div id="precoHelp" class="form-text">Digite o preço do carro.</div>
                    </div>

                    <div class="mb-3">
                        <label for="InputImagem" class="form-label">Marca</label>
                        <input name="imagem" type="text" class="form-control" id="InputImagem" aria-describedby="imagemHelp">
                        <div id="imagemHelp" class="form-text">Digite o marca do carro.</div>
                    </div>
